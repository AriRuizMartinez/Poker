...
");
        ...
        private static void JugarBatallaDeCartas()
        {
...
El ganador de la ronda ha sido " + ganador.ToString());
        ...
        private static void JugarPoker()
        {
            int numeroJugadores = PedirNumero();
        ...
        private static void RepartirPareja(List<JugadorPoker> jugadores, Baraja baraja)
        {
